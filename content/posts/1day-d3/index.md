...
D3.js を使って、ウェブで動くインタラクティブな可視化を自分の手で書けるようになるための1日講座です。SVG、DOM操作、データバインディング、スケール、インタラクションまで、D3.js の基礎を一気通貫で扱います。

### こんな方におすすめ

- 既成のチャートツールでは表現しきれない可視化を作りたい方
- D3.js の基礎を短時間で体系的に押さえたい方
- ウェブ上で公開・共有できるインタラクティブな成果物を作りたい方
- HTML/CSS/JavaScript の基本を使って可視化制作に踏み込みたい方
...
少人数制で、コードを読み、書き、動かしながら進めます。完成コードを眺めるだけではなく、静的チャートから動的チャートへ段階的に発展させ、D3.js の考え方を手で確かめます。

### 使用するツール・事前準備

- D3.js
- 任意のテキストエディタ（Visual Studio Code 推奨）
- 生成AIツール（ご用意できるもので構いません）

ノートPC、インターネットブラウザ、任意のテキストエディタをご用意ください。事前に最低限の HTML/CSS/JavaScript の知識があるとスムーズです。
